...
//         <div className="winner-animation-constiner">
//           <div className="winner-animation">
//             <div className="outer-spinner">
//               <div className="outer-spinner__front"></div>
//               <div className="outer-spinner__back"></div>
//             </div>
//             <div className="inner-spinner">
//               <div className="inner-spinner__front"></div>
//               <div className="inner-spinner__back">
...
const GameOverComponent: React.FC<GameOverComponentProps> = ({ winner, playerXName, playerOName, onReset, onQuit }) => {
  ...
  return (
    <div className="game-over">
      {isModalOpen && <WinAnimation winner={winnerName} onClose={handleCloseModal} onQuit={onQuit} />}
    </div>
  );
};
